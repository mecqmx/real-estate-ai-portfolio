## Portfolio Documentation Checklist (Prioritized)
...
*   [ ] **Environment Variables:**
    *   [ ] Document all required environment variables in the `README.md` or a separate `.env.example` file (without revealing sensitive values).  Explain the purpose of each variable.

**II. Important Documentation (Complete Soon)**

*   [ ] **Component Documentation:**
    *   [ ] For complex or reusable components, add comments or separate documentation files explaining their purpose, props, and usage.  Use JSDoc syntax for comments.
...
*   [ ] **Testing Documentation:**
    *   [ ] If you have unit tests or integration tests, document how to run them and what they cover.
*   [ ] **Deployment Documentation:**
    *   [ ] Explain how you deployed your portfolio (e.g., Vercel, Netlify).
*   [ ] **Contribution Guidelines:**
    *   [ ] If you plan to make your portfolio open source, add contribution guidelines.
*   [ ] **Storybook Integration:**
    *   [ ] If you use Storybook for component development, document how to use it.
